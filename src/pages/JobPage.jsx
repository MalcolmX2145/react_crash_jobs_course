import { useParams, useLoaderData, useNavigate } from "react-router-dom"; // allows us to get the id value from the jobs.json file and us it in this code
...
// function to fetch data from jobs.json by its id
